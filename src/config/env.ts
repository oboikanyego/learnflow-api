...
const schema = z.object({
  ...
  YOUTUBE_SEARCH_GLOBAL_DAILY_LIMIT: z.coerce.number().int().min(1).max(100000).default(80),
  YOUTUBE_SEARCH_USER_DAILY_LIMIT: z.coerce.number().int().min(1).max(10000).default(20),
  YOUTUBE_SEARCH_USER_HOURLY_LIMIT: z.coerce.number().int().min(1).max(1000).default(8),
